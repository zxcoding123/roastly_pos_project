...
<div class="min-h-screen flex flex-col overflow-x-hidden bg-black text-white">
  <nav class="fixed top-0 w-full z-[100] border-b border-white/5 bg-black/50 backdrop-blur-md">
    <div class="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
      <a href="/" class="flex items-center gap-2 outline-none">
        <div class="w-8 h-8 0 rounded-lg shadow-lg"><img src="{coffeeLogo}" alt="Roastly Logo" class="w-full h-full object-cover" /></div>
        <span class="text-xl font-bold tracking-tight">Roastly.</span>
      </a>
      ...
      <button class="hidden md:block btn-primary text-sm px-5 py-2 cursor-pointer">Get Started</button>
       </a>
    </div>
  </nav>
  ...
  {#if isMenuOpen}
    ...
    <div 
      ...
      class="fixed inset-0 z-[90] flex flex-col p-10 justify-center bg-black"
    >
      <div class="space-y-6">
      ...
      <div class="mt-8 pt-10 border-t border-white/10" transition:fade={{ delay: 500 }}>
        ...
        <div class="flex flex-col gap-2">
          ...
          <br>
           <a href="tel:+639536640119" class="text-white font-bold text-lg">+63 930 027 568019</a>
          <a href="mailto:ahmadaquino.2002@gmail.com" class="text-blue-400 font-medium">ahmadaquino.2002@gmail.com</a>
        </div>
      </div>
    </div>
